...
<head>
    ...
    <title>HR System PT. Balai Lelang Star</title>
    <!-- Bootstrap Core CSS -->
...
<body>
    ...
    <section id="wrapper" class="login-register login-sidebar" style="background-image:url(<?php echo base_url(); ?>assets/images/background/fix-bg.jpg);">
        ...
        <div class="login-box card">
            <div class="card-body loginpage">
                ...
                <form class="form-horizontal form-material" method="post" id="loginform" action="login/Login_Auth">
                    <a href="javascript:void(0)" class="text-center db"><br/><img src="<?php echo base_url(); ?>assets/images/download.png" width="175px" alt="Home" /></a>
